...
using RealVsToyML.Model;
using Microsoft.ML.Vision;

namespace RealVsToyML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Tomasz Cekało\AppData\Local\Temp\ba40fcbb-3ea7-453b-bf26-d71e2ce39ace.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\Tomasz Cekało\AppData\Local\Temp\MLVSTools\RealVsToyML\RealVsToyML.Model\MLModel.zip";
